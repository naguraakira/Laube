...
public final class CommonActivityDao extends ActivityDao {

	/**
	 * to manage the log object.<br>
	 */
	private static LaubeLogger log = new LaubeLogger(LaubeLoggerFactory.getLogger(CommonActivityDao.class));
