...
/**
 * DraftAcceptor class is passing the message class for the operator and the framework.<br>
 * All of the Draft Acceptor is add an item to this class.<br>
 *
 * @version    1.0.0
...
public final class DraftAcceptor extends RequestSystemAcceptor {
	 ...
	 */
	private static Logger log = LoggerFactory.getLogger(DraftAcceptor.class);
