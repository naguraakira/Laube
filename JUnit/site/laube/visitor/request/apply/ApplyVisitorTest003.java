 ...
 *
 */
public class ApplyVisitorTest003 {

	/**
	 * to manage the log.<br>
	 */
	private static Logger log = LoggerFactory.getLogger(ApplyVisitorTest003.class);
	...
	public void testDoApply() {
		...
		RequestSystemAcceptor requestSystemAcceptor = new ApplyAcceptor();
		RequestSystemVisitor requestSystemVisitor = new ApplyVisitor();
