...
/**
 * 通常申請(ルート設定矛盾でエラーとなるパターン:無限ループ)
 * @author mikir
 *
 */
public class ApplyVisitorTest009 {

	/**
	 * to manage the log.<br>
	 */
	private static Logger log = LoggerFactory.getLogger(ApplyVisitorTest009.class);
