...
/**
 * 下書き申請→下書き申請(NextPartyCodeの抜け、AND分岐)
 * @author mikir
 *
 */
public class ApplyVisitorTest034 {

	/**
	 * to manage the log.<br>
	 */
	private static Logger log = LoggerFactory.getLogger(ApplyVisitorTest034.class);
