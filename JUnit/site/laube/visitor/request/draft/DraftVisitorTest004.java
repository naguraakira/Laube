 ...
 *
 */
public class DraftVisitorTest004 {

	/**
	 * to manage the log.<br>
	 */
	private static Logger log = LoggerFactory.getLogger(DraftVisitorTest004.class);
	...
	public void testDoApply() {
		...
		try {
			...
			// 下書き申請されたデータを下書き更新します。
			Object o = result.getResultData();
			int applicationNumber = (int)o;
			requestSystemAcceptor = new DraftAcceptor();
